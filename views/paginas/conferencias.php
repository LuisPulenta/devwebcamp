                        ...
                        <p class="evento__hora"> <?php echo $evento->hora->hora?></p>
                            ...
                            <div class="evento__informacion">
                                ...
                                <picture>
                                    ...
                                    <img class="evento__imagen-autor" loading="lazy" width="200" heigth ="300" wsrc="<?php echo $_ENV['HOST'] . '/img/speakers/' . $evento->ponente->imagen; ?>.png" alt="Imagen Ponente">
                                </picture>
